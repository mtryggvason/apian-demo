...
export default function Page({endpoints = LOCATIONS}) {
  ...
  useEffect(() => {
    ...
    map.current.flyTo({center: [location.lat, location.lng,], bearing: map.current.getBearing() + 10});
    /*
  ...
  antialias
    ...
    >
   <Canvas frameloop='always' altitude={100} latitude={location.lng} longitude={location.lat}>
