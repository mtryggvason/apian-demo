...
export default function App() {
  ...
  return (
    <div className="w-screen h-screen bg-sky-500/50">
      ...
      <h1 className="text-red-400 w-full text-4xl font-bold text-center p-">
      ...
      <div className="z-10 w-screen absolute bottom-2 left-1/2 transform -translate-x-1/2  block sm:max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        ...
        <p className="font-normal text-gray-700 dark:text-gray-400">
          The 10T drone is a light weight transporter used to carry Patholgy
          samples between <strong>Guys</strong> and{" "}
          <strong>St Thomas Hospitals</strong>
        </p>
        <Link
          href="/map"
          className="inline-block mt-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full"
        >
          Track it!
        </Link>
      </div>
